...
class HomePageModel {
    ...
    factory HomePageModel.fromJson(Map<String, dynamic> json) => HomePageModel(
        ...
        bottomSliderArray: List<SliderArray>.from(json["bottom_slider_array"].map((x) => SliderArray.fromJson(x))),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "bottom_slider_array": List<dynamic>.from(bottomSliderArray!.map((x) => x.toJson())),
